            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center">
                        <h1 class="page-title">Home Decor Collections</h1>
                        <ul class="breadcrumb justify-content-center">
                            <li><a href="index.php">Home</a></li>
                            <li class="current"><span>Home Decor Collections </span></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-4">
                            <div class="banner-box banner-type-3 banner-type-3-1 banner-hover-1">
                                <div class="banner-inner">
                                    ...
                                    <div class="banner-info">
                                        <p class="banner-title-1 lts-13 lts-lg-4 text-uppercase">Wall Hangings</p>
                                        <h2 class="banner-title-2">The <strong>Wall Hangings</strong></h2>
                                    </div>
                                    <a class="banner-link banner-overlay" href="productsview.php">Shop Now</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="banner-box banner-type-3 banner-type-3-1 banner-hover-1">
                                <div class="banner-inner">
                                    ...
                                    <div class="banner-info">
                                        <p class="banner-title-1 lts-13 lts-lg-4 text-uppercase">Table Tuner</p>
                                        <h2 class="banner-title-2">The <strong>Table Tuner</strong></h2>
                                    </div>
                                    <a class="banner-link banner-overlay" href="productsview.php">Shop Now</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="banner-box banner-type-3 banner-type-3-1 banner-hover-1">
                                <div class="banner-inner">
                                    ...
                                    <div class="banner-info">
                                        <p class="banner-title-1 lts-13 lts-lg-4 text-uppercase">Painting</p>
                                        <h2 class="banner-title-2">The <strong>Painting</strong></h2>
                                    </div>
                                    <a class="banner-link banner-overlay" href="productsview.php">Shop Now</a>
                                </div>
                            </div>
