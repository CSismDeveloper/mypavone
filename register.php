...
<body>
    ...
    <div class="form__group mb--20">
        <label class="form__label form__label--2" for="full_name">Full Name <span class="required">*</span></label>
        <input type="text" class="form__input form__input--3" id="full_name" name="full_name" required>
    </div>
    <div class="form__group mb--20">
        <label class="form__label form__label--2" for="email">Email Address <span class="required">*</span></label>
        <input type="email" class="form__input form__input--3" id="email" name="email" required>
    </div>
    <div class="form__group mb--20">
        <label class="form__label form__label--2" for="mobile">Mobile Number <span class="required">*</span></label>
        <input type="tel" class="form__input form__input--3" id="mobile" name="mobile" pattern="[0-9]{10}" maxlength="10" required>
    </div>
    <div class="form__group mb--20">
        <label class="form__label form__label--2" for="password">Password <span class="required">*</span></label>
        <input type="password" class="form__input form__input--3" id="password" name="password" minlength="6" required>
    </div>
    <div class="form__group mb--20">
        <label class="form__label form__label--2" for="confirm_password">Confirm Password <span class="required">*</span></label>
        <input type="password" class="form__input form__input--3" id="confirm_password" name="confirm_password" minlength="6" required>
    </div>
