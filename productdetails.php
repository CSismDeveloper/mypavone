...
<body>
    ...
    <div class="wrapper">
      ...
      <?php include("header.php") ?>
        ...
        <div class="breadcrumb-area pt--70 pt-md--25" style="top:160px">
                    ...
                    <div class="row pt--40">
                        ...
                        <div class="col-md-6 product-main-details mt--40 mt-md--10 mt-sm--30">
                            <div class="product-summary">
                                ...
                                <form action="cart.php" class="form--action mb--30 mb-sm--20">
                                    <div class="product-action flex-row align-items-center">
                                        <div class="quantity">
                                            <input type="number" class="quantity-input" name="qty" id="qty" value="1"
                                                min="1">
                                        </div>
                                        <button type="button" class="btn btn-style-1 btn-large add-to-cart" onclick="window.location.href='cart.php'">
                                            Add To Cart
                                        </button>
