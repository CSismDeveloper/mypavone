                ...
                <div class="container">
                    ...
                    <div class="col-md-3 mb-sm--30">
                        ...
                        <div class="col-md-6 mb-sm--30">
                            <div class="login-box">
                                <h4 class="mb--35 mb-sm--20 text-center">Forget Password</h4>
                                <form class="form form--login">
                                    <div class="form__group mb--20">
                                        <label class="form__label form__label--2" for="username_email">email
...
<a class="forgot-pass text-center" href="login.php">Already Register Click Here?</a>
