                            ...
                            <div class="footer-widget">
                                ...
                                <ul class="contact-info">
                                    <li class="contact-info__item">
                                        ...
                                        <span><a href="tel:+012345 6788" class="contact-info__link">(+91) 123456789</a></span>
                                    </li>
                                    <li class="contact-info__item">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center">
                            <p class="copyright-text">&copy; AIRI 2021 MADE WITH <i class="fa fa-heart"></i> BY CSism Technologies</p>
                        </div>
                    </div>
                </div>
            </div>
